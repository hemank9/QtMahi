...
class ExtraDosage(QWidget):                           # <===
    ...
    def UiComponents(self):
        ...
        btnok.setStyleSheet("border-radius : 10; background-color: #F0F0F3; font : bold; color : #00A0B5; font-size:20px")
        ...
        lblChangeFreq.setGeometry(18, 322, 294, 29)
        ...
        btnfreqHourlyInc1.setGeometry(511, 534, 33, 45)
        ...
        btnfreqHourlyInc.setGeometry(511, 534, 33, 45)
        ...
        btnfreqTimesInc1.setGeometry(511, 583, 33, 45)
        ...
        btnfreqTimesInc.setGeometry(511, 583, 33, 45)
        ...
        self.lblHour.setGeometry(746, 531, 30, 21)
        self.lblHour.setAlignment(QtCore.Qt.AlignCenter)
        self.lblHour.setStyleSheet("background-color : #00000000")
        ...
        self.lblMin.setGeometry(822, 531, 30, 21)
