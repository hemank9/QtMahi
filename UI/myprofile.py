...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        # Allergies
        lblAllergies = QLabel("Multi label i.e With multi line", self)
        lblAllergies.setGeometry(54, 393, 254, 114)
        lblAllergies.setStyleSheet("background-color : #F0F0F3; border-radius : 15")
        lblAllergies.setWordWrap(True)
        ...
        # Birth History
        lblBirthHistory = QLabel("Multi label i.e With multi line", self)
        lblBirthHistory.setGeometry(595, 393, 270, 119)
        lblBirthHistory.setStyleSheet("background-color : #F0F0F3; border-radius : 15")
        lblBirthHistory.setWordWrap(True)
        l6 = QLabel("Birth History", self)
        l6.setGeometry(575, 345, 124, 29)
        l6.setStyleSheet("color:#EE488D; font: 21px; background-color: #F0F0F3")

        # medical procedure
        lblMedProcedure = QLabel("Multi label i.e With multi line", self)
        lblMedProcedure.setGeometry(900, 255, 277, 252)
        lblMedProcedure.setStyleSheet("background-color : #F0F0F3; border-radius : 15")
        lblMedProcedure.setWordWrap(True)
