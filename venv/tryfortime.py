...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        btnMorning.setStyleSheet("border-radius : 15; background-color: white; color : #00A0B5")
        ...
        btnAfternoon.setStyleSheet("border-radius : 15; background-color: white; color : #00A0B5")
        shadow = QGraphicsDropShadowEffect()
        shadow.setBlurRadius(25)
        ...
        btnEvening.setStyleSheet("border-radius : 15; background-color: white; color : #00A0B5")
        shadow = QGraphicsDropShadowEffect()
        shadow.setBlurRadius(25)
        shadow.setColor(Qt.lightGray)
