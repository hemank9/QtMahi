...
class FileListItem(QWidget):
    def __init__(self, parent=None):
        ...
        self.lblFileName.setStyleSheet("margin-left:20px;color:#006CB5; font:bold; font-size:25px;")
        self.lblDateDoctor = QLabel()
        self.lblDateDoctor.setWordWrap(True)
        self.lblDateDoctor.setStyleSheet("color:#006CB5; font-size:18px; margin-right:20;")
        ...
        self.lblExtension.setStyleSheet("color:#006CB5; font-size:18px; margin-right:20;")
